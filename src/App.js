...
function App() {
  return (
    ...
    <div>
      ...
      <h1> We exist to help creators<br></br>
        own their audience.
      </h1>
      <h6>
      ...
      <main>
        <p>
          Building a career on social platforms is like building a home on someone else's land. While social
          platforms are great for discovering and reaching your audience,
      ...
      <footer>
        ...
        <a href="https://www.figma.com/file/BPYbUCjYNRQXBt5AKSrgtV/Marico-%2B?node-id=0%3A765&t=iTNpR8pSn1ZZzMIb-0"> Original design
        </a>

        <div>
          Author: Stepan Ptashets
        </div>
